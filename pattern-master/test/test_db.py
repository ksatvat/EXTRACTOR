...
class TestDate(unittest.TestCase):
    ...
    def test_date(self):
        # Assert string input.txt and default date formats.
        for s in (
          "2010-09-21 09:27:01",
...
class TestUtilityFunctions(unittest.TestCase):
    ...
    def test_json(self):
        # Assert JSON input.txt and output.
